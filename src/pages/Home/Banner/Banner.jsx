        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute flex items-center h-full left-0  top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21)]">
            <div className="text-white space-y-7 w-1/2 pl-12">
              ...
              <div>
                <button className="btn btn-primary mr-5 bg-[#ff3535] hover:bg-[#fc6363] border-0">
                  Discover More
                </button>
                <button className="btn btn-outline border-white text-white hover:text-black hover:bg-white">
                  Latest Project
                </button>
              </div>
            </div>
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
            ...
            <a
              href="#slide2"
              className="btn btn-circle bg-[#FF3811] text-white border-0"
            >
              ❯
            </a>
          </div>
